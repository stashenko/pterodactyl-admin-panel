    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        <div class="wrapper">
                ...
                <section class="sidebar">
                    @if (isset($server->name) && isset($node->name))
                        <div class="user-panel">
                            <div class="info">
                              <p>{{ $server->name }}</p>
                              <a href="#" id="server_status_icon"><i class="fa fa-circle text-default"></i> Проверка...</a>
                            </div>
                        </div>
                    @endif
            ...
            <footer class="main-footer">
                ...
                Copyright &copy; 2015 - {{ date('Y') }} <a href="https://pterodactyl.io/" target="_blank">Pterodactyl Software</a>. Перевод на русский язык <a href="http://spigotmc.ru" target="_blank">spigotmc.ru</a>
            </footer>
            @if(isset($sidebarServerList))
