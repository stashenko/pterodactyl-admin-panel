    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        <li class="header">ОСНОВНОЕ УПРАВЛЕНИЕ</li>
                        ...
                        <li class="{{ Route::currentRouteName() !== 'admin.statistics' ?: 'active' }}">
                            <a href="{{ route('admin.statistics') }}">
                                <i class="fa fa-tachometer"></i> <span>Статистика</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.locations') ?: 'active' }}">
                            <a href="{{ route('admin.locations') }}">
                                <i class="fa fa-globe"></i> <span>Распределения</span>
                            </a>
                        </li>
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.nodes') ?: 'active' }}">
                            <a href="{{ route('admin.nodes') }}">
                                <i class="fa fa-sitemap"></i> <span>Узлы</span>
                            </a>
                        </li>
                        ...
                        <li class="header">УПРАВЛЕНИЕ СЕРВИСОМ</li>
                        ...
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.packs') ?: 'active' }}">
                            <a href="{{ route('admin.packs') }}">
                                <i class="fa fa-archive"></i> <span>Пакеты</span>
                            </a>
                        </li>
                    </ul>
                </section>
            ...
            <footer class="main-footer">
                ...
                Copyright &copy; 2015 - {{ date('Y') }} <a href="https://pterodactyl.io/" target="_blank">Pterodactyl Software</a>. Перевод на русский язык <a href="http://spigotmc.ru" target="_blank">spigotmc.ru</a><br/>
            </footer>
        </div>
