            ...
            <div class="col-sm-8 col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Выбор прав</h3>
                    </div>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">После того, как вы назначите разрешения и создадите этот набор учетных данных, вы не сможете вернуться и отредактировать его. Если вам нужно внести изменения в будущем, вам нужно будет создать новый набор учетных данных.</p>
                    </div>
