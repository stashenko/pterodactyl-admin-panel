                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Это должно быть описываемое имя категории, которое охватывает все параметры службы.</small></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Описание <span class="field-required"></span></label>
                        <div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Уникальный идентификатор, используемый для идентификации этого гнезда внутри и через API.</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Автор этого варианта сервиса. Пожалуйста, направляйте вопросы и вопросы к ним, если это не официальный вариант, созданный <code>support@pterodactyl.io</code>.</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">UUID для всех серверов, использующих эту опцию, назначено для целей идентификации.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Яйца в гнезде</h3>
            </div>
