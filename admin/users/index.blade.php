...
@section('content-header')
    <h1>Пользователи<small>Все зарегистрированные пользователи в системе.</small></h1>
    <ol class="breadcrumb">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Servers that this user is marked as the owner of.">Собственные серверы</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Servers that this user can access because they are marked as a subuser.">Может получить доступ</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
