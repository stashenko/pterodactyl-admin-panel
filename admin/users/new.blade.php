            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>Предоставление пароля пользователя не является обязательным. Электронное письмо пользователю предлагает создать пароль при первом входе в систему. Если здесь указан пароль, вам нужно будет найти другой способ предоставления его пользователю.</p>
                    </div>
