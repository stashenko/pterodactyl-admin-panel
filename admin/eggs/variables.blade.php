                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['id' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <p class="text-muted small">Эта переменная может быть доступна в команде запуска с помощью <code>{{ $variable->env_variable }}</code>.</p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">Эти правила определяются с использованием стандартных правил проверки Laravel Framework.</p>
                        </div>
                    </div>
            ...
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">Эта переменная может быть доступна в команде запуска, введя <code>@{{environment variable value}}</code>.</p>
                        </div>
                    </div>
                    <div class="form-group">
